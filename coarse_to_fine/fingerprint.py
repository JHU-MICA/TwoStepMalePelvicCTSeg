...
if __name__ == '__main__':
    ...
    data_loc = pd.read_csv(os.path.join(DATA_BASE,'data_locs','enhanced_prostate_data_loc.csv'))

    test_loc = data_loc.loc[:12]
    train_loc = data_loc.loc[13:]

    get_fingerprint(train_loc,'enhanced_prostate')