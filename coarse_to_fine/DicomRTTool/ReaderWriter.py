...
class DicomReaderWriter(object):
    ...
    def prediction_array_to_RT(self, prediction_array: np.array, output_dir: typing.Union[str, bytes, os.PathLike],
                               ROI_Names: List[str], ROI_Colors = None) -> None:
        """
        ...
        :param ROI_Colors: dict of rgb colors to use for rois (optional, roi: color)
        :return:
        """
    ...
    def mask_to_contours(self) -> None:
        ...
        for Name in self.ROI_Names:
            ...
            if self.ROI_Colors is not None:
                self.RS_struct.ROIContourSequence[self.struct_index].ROIDisplayColor = self.ROI_Colors[Name]
            else:        
